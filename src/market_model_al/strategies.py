...
STRATEGIES = [
    ...
    "random_cp", "random_market",
    "uncertainty_cp", "error_based_cp", "segment_adaptive_cp", "disruption_cp",
    ...
    # informed_market adds error-based scoring; cube_market uses balanced sampling.
    "informed_market",
    "cube_market",
]
